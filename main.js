...
var sentence_negative = {
    sc: [
        ...
        "#N可以满世界抹黑攻击中国，难道中国大使就不能提到#B吗？这是什么逻辑？你是不是觉得中国还是应该处于那样的时候，即#N可以满世界抹黑攻击打压我们，而我们连名字都不可以提，更不能还嘴，是这样吗？",
        "#N本来应该是可以坚持客观公正的丶忠于事实真相的丶维护社会公平正义的，但令人非常遗憾和可悲的是，我们看到#N并没有这么做。#N显然走到了一条非常错误的道路上，这样的行为应当引起大家高度警惕，也应该立即得到纠正。",
    ...
    tc: [
        ...
        "#N可以滿世界抹黑攻擊中國，難道中國大使就不能提到#B嗎？這是什麼邏輯？你是不是覺得中國還是應該處於那樣的時候，即#N可以滿世界抹黑攻擊打壓我們，而我們連名字都不可以提，更不能還嘴，是這樣嗎？",
        "#N本來應該是可以堅持客觀公正的、忠於事實真相的、維護社會公平正義的，但令人非常遺憾和可悲的是，我們看到#N並沒有這麼做。#N顯然走到了一條非常錯誤的道路上，這樣的行為應當引起大家高度警惕，也應該立即得到糾正。",
...
var sentence_positive = {
    ...
    tc: [
        ...
        "#N此舉取得豐碩成果，將為中國與#N全天候戰略合作伙伴關系增添新的動力。",
        "我們剛剛隆重慶祝了新中國成立70周年，#N向中方送上了真摯美好的祝福，我們對此表示誠摯的感謝。",
