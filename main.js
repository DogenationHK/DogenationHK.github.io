...
var sentence_negative = {
    sc: [
        ...
        "#N#B的行为就有如德国作家埃里希·玛利亚·雷马克所着的《西线无战事》中主角保罗一样，即使其自以为上前线打仗是要保家卫国，但其行为始终是赤裸裸的侵略行为！",
        "#N及其#B的阴谋也将像保罗的下场一样：默默无闻的消逝於天地之间！",
    ...
    tc: [
        ...
        "#N#B的行為就有如德國作家埃裡希·瑪利亞·雷馬克所著的《西線無戰事》中主角保羅一樣，即使其自以為上前線打仗是要保家衛國，但其行為始終是赤裸裸的侵略行為！",
        "#N及其#B的陰謀也將像保羅的下場一樣：默默無聞的消逝於天地之間！",
